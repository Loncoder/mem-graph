...
// 测试一下mapperReduce读取hbase的速度,并且将求取的结果写进redis;
//如果速度太慢,可以用多线程扫描分不同的区间段扫描HBase表格对此进行优化改进
public class Main extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        //conf.set(ConstantMR.FS, conf_e.get(ConstantMR.FS),"hdfs://127.0.0.1:9000");
        //conf.set(ConstantMR.YARN, conf_e.get(ConstantMR.YARN), "127.0.0.1");
        ...
        TableMapReduceUtil.initTableMapperJob(linkGraphName, scan, ImFactorMapper.class, ImmutableBytesWritable.class,
                Text.class, job);
